...
/**
 * Classe RepresentationPion
 */
public class RepresentationPion extends Representation {
    private final static char p = 'p'; // Representation pion
    ...
    public void setupDrawable(Context p_context) {
        switch (m_couleur) {
            case BLANC :
                m_drawable = ResourcesCompat.getDrawable(p_context.getResources(), R.drawable.pionblanc_image, null);
                break;
            case NOIR :
                m_drawable = ResourcesCompat.getDrawable(p_context.getResources(), R.drawable.pionnoir_image, null);
        }
    }

    /**
     * Constructeur Representation Pion
     * @param p_couleur couleur du pion à représenté
     */
    public RepresentationPion(Piece.Couleur p_couleur) {
        m_couleur = p_couleur;
    }
}